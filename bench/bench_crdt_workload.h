...
/* Same, for the closure-derived subset in bench/data/crdt-small (Issue
 * #947).  Generated by scripts/perf/make_crdt_subset.py at threshold 2000:
 * 1674 inserts, 1412 removes, so 1674 - 1412 - 1 = 261.  The minus one is
 * the root, which has no predecessor; see the script for why the projection
 * in the result rule cannot collide and the subtraction is exact. */
#define WL_BENCH_CRDT_SMALL_RESULT_TUPLES ((int64_t)261)
