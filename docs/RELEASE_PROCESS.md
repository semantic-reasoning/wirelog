...
4. **Tag** on `main`:
   ...
   provenance attestation only after this gate succeeds. It then signs the
   archive with Sigstore keyless signing and attaches the archive, checksums,
   signature and attestation to the GitHub Release. The SBOM and ABI manifest
