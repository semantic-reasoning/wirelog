...
### 5.14 `wirelog/columnar/relation.c` and `session.c` — alias ownership and pool promotion (20 rows)
...
104 + 11 + 20 = **135 atomic call sites**.
...
The complete source audit now contains **184 atomic call sites**.
