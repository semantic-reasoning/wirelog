...
def main():
    ...
    for label, directory in [('reference', 'wirelog-1972-reference-7e498e7')]:
    ...
    write(HERE / 'reference-campaign-complete.json', {'completed_at': now(), 'required_records_per_source': 48})
