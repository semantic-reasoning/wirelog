/*
 * test_diff_arrangement_inline_shadow.c - differential arrangement deep-copy semantics over inline
 ...
 * Tests:
 *
 *   test_diff_arrangement_inline_shadow
...
{
    col_rel_t *r = NULL;
    int rc = col_rel_alloc(&r, "diff_arrangement_shadow");
    if (rc != 0)
        return rc;
...
static void
test_diff_arrangement_inline_shadow(void)
{
...
main(void)
{
    printf("test_diff_arrangement_inline_shadow (Issue #532 Task 4)\n");
    printf("===============================================\n");
