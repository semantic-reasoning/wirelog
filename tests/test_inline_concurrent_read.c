/*
 * test_inline_concurrent_read.c - TSan stress: K=4 concurrent readers over
 ...
 *
 * Validates zero data races on inline column access when K=4 inline compound
 ...
 *
 *   test_inline_concurrent_insert_delete
...
static void
test_inline_concurrent_read(void)
{
 ...
 */
static void
test_inline_concurrent_insert_delete(void)
{
    TEST(
...
main(void)
{
    printf("test_inline_concurrent_read (Issue #534 Task 3)\n");
    printf("================================================\n");
